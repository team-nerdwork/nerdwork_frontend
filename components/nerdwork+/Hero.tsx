...
export default function ProductHero() {
  return (
    <header className="relative min-h-screen w-full">
      <div className="absolute inset-0 bg-[url('https://res.cloudinary.com/dk4gmufzn/image/upload/v1759855759/plus-hero_tszrra.png')] bg-cover bg-center bg-no-repeat z-0" />
